...
export class EventStoreModule {
  static register(option: EventStoreModuleOptions): DynamicModule {
    return {
      ...
      imports: [
        EventStoreCoreModule.register(option),
  ...
  static registerAsync(option: EventStoreModuleAsyncOptions): DynamicModule {
    return {
      module: EventStoreModule,
      imports: [
        EventStoreCoreModule.registerAsync(option),
        TypeOrmModule.forFeature([ProjectionDto]),
      ],
    };
  }
  ...
  static registerFeature(config: EventStoreOptionConfig): DynamicModule {
    return {
      module: EventStoreModule,
      imports: [
        EventStoreCoreModule.registerFeature(config),
        TypeOrmModule.forFeature([ProjectionDto]),
      ],
      providers: [MongoStore],
    };
  ...
  static registerFeatureAsync(
    ...
    return {
      module: EventStoreModule,
      imports: [
        EventStoreCoreModule.registerFeatureAsync(options),
        TypeOrmModule.forFeature([ProjectionDto]),
      ],
    };
  }
