...
export enum EMicroservice {
  ...
  GATEWAY_SELLER_CHANNEL_SERVICE = 'GATEWAY_SELLER_CHANNEL_SERVICE',
  GATEWAY_UPLOAD_FILE_SERVICE = 'GATEWAY_UPLOAD_FILE_SERVICE',
}
...
export enum EKafkaMessage {
  ...
  REQUEST_CREATE_API_KEY = 'REQUEST_CREATE_API_KEY',
}
